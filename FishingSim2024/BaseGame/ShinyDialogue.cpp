...
bool ShinyDialogue::DialogueUpdate(PlayerData* pd)
{
	progress = progress + 2;

	name.setString(shinyText.shinyDialogue.at(1).at(progress));
	dialogue.setString(shinyText.shinyDialogue.at(1).at(progress + 1));
