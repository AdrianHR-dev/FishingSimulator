...
void TestCharacter::handleInput(float dt)
{
...
bool TestCharacter::interact(PlayerData* pd)
{
	talking = true;
	...
	testDialogue.setAlive(true);

	if (testDialogue.DialogueUpdate(pd) == false)
	{

		switch (testDialogue.getCurrState(pd))
		{
...
void TestCharacter::endConvo(PlayerData* pd)
{
