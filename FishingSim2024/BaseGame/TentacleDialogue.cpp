...
bool TentacleDialogue::DialogueUpdate(PlayerData* pd)
{
	progress = progress + 2;

	name.setString(tentacleText.tentacleDialogue.at(1).at(progress));
	dialogue.setString(tentacleText.tentacleDialogue.at(1).at(progress + 1));
