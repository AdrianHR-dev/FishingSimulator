...
bool ShoeDialogue::DialogueUpdate(PlayerData* pd)
{
	progress = progress + 2;

	name.setString(shoeText.shoeDialogue.at(1).at(progress));
	dialogue.setString(shoeText.shoeDialogue.at(1).at(progress + 1));
